...
public class ConnectionSQL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnConnection.setAlignmentY(0.0F);
    ...
    private void btnConnectionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectionActionPerformed
        ...
        try {
            Statement sql = ConnectionX.getConnection().createStatement();
            String queryX = "SELECT * FROM [test].[sys].[tables]";
            ResultSet result = sql.executeQuery(queryX);
            
            while (result.next()) {
                bases += result.getString("name") + "\n";
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConnectionSQL.class
